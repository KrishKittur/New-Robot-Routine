...
public class RunEndAcceleratorShooterCommand extends CommandBase {
    ...
    public RunEndAcceleratorShooterCommand(AcceleratorSubsystem acceleratorSubsystem, ShooterSubsystem shooterSubsystem, VisionSubsystem visionSubsystem) {
    ...
    // In the end method of this command set the motors to 0
    @Override
    public void end(boolean interrupted) {
        acceleratorSubsystem.setAcceleratorMotorBV(0);
        shooterSubsystem.spinShooterBV(0, 0);
    }
